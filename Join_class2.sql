...
-- Quesry 1
select student.ID as Student_ID, student.std_name as Student_name,courses.courseID, courses.course_name,Teachers.TeachersID,Teachers.Teachersname
from ((student
inner join Courses on student.courseID=Courses.courseID)
inner join Teachers on Courses.TeachersID=Teachers.TeachersID);

-- Query 2
select  student.std_name as Student_name, courses.course_name,Teachers.Teachersname
from ((student
inner join Courses on student.courseID=Courses.courseID)
inner join Teachers on Courses.TeachersID=Teachers.TeachersID);
...
-- Query 4
select  student.ID as Student_ID,courses.courseID,Teachers.TeachersID
from ((student
inner join Courses on student.courseID=Courses.courseID)
inner join Teachers on Courses.TeachersID=Teachers.TeachersID);
